                    ...
                    <>
                      ...
                      <div className="space-y-1">
                        {dayEvents.slice(0, 3).map((event: CalendarEvent) => {
                          const bgColor = event.isAutoGenerated 
                            ? (event.type === 'delivery' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800')
                          ...
                          return (
                            <div
                              ...
                              className={`text-xs p-1 rounded border ${bgColor} ${
                                event.isAutoGenerated ? 'cursor-default border-dashed' : 'cursor-pointer hover:shadow-sm'
                              }`}
                              onClick={(e) => {
                                e.stopPropagation();
